...
private:
	...
	static v8::Handle<v8::Value> getResRawDirectory(const v8::Arguments&);
	...
	static v8::Handle<v8::Value> getter_resRawDirectory(v8::Local<v8::String> property, const v8::AccessorInfo& info);
