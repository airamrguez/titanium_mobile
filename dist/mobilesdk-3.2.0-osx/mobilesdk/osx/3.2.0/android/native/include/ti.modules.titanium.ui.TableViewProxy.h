...
private:
	// Methods -----------------------------------------------------------
	static v8::Handle<v8::Value> deleteSection(const v8::Arguments&);
	static v8::Handle<v8::Value> getIndexByName(const v8::Arguments&);
	static v8::Handle<v8::Value> selectRow(const v8::Arguments&);
	...
	static v8::Handle<v8::Value> updateSection(const v8::Arguments&);
	...
	static v8::Handle<v8::Value> insertSectionAfter(const v8::Arguments&);
	static v8::Handle<v8::Value> updateRow(const v8::Arguments&);
	static v8::Handle<v8::Value> insertSectionBefore(const v8::Arguments&);
