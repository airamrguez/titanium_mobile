...
private:
	...
	static v8::Handle<v8::Value> openOptionsMenu(const v8::Arguments&);
	...
	static v8::Handle<v8::Value> invalidateOptionsMenu(const v8::Arguments&);
	static v8::Handle<v8::Value> setResult(const v8::Arguments&);
	static v8::Handle<v8::Value> getActionBar(const v8::Arguments&);
	...
	static v8::Handle<v8::Value> getter_actionBar(v8::Local<v8::String> property, const v8::AccessorInfo& info);
