...
private:
	...
	static v8::Handle<v8::Value> addTrustManager(const v8::Arguments&);
	...
	static v8::Handle<v8::Value> setDomain(const v8::Arguments&);
	static v8::Handle<v8::Value> setAutoEncodeUrl(const v8::Arguments&);
	static v8::Handle<v8::Value> setPassword(const v8::Arguments&);
	...
	static v8::Handle<v8::Value> getPassword(const v8::Arguments&);
	static v8::Handle<v8::Value> addAuthFactory(const v8::Arguments&);
	...
	static v8::Handle<v8::Value> addKeyManager(const v8::Arguments&);
	static v8::Handle<v8::Value> getDomain(const v8::Arguments&);
	...
	static v8::Handle<v8::Value> getter_password(v8::Local<v8::String> property, const v8::AccessorInfo& info);
	static void setter_password(v8::Local<v8::String> property, v8::Local<v8::Value> value, const v8::AccessorInfo& info);
	...
	static v8::Handle<v8::Value> getter_domain(v8::Local<v8::String> property, const v8::AccessorInfo& info);
	static void setter_domain(v8::Local<v8::String> property, v8::Local<v8::Value> value, const v8::AccessorInfo& info);
