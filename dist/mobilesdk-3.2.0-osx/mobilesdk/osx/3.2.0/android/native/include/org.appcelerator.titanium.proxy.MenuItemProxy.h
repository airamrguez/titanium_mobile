...
private:
	...
	static v8::Handle<v8::Value> setShowAsAction(const v8::Arguments&);
	...
	static v8::Handle<v8::Value> expandActionView(const v8::Arguments&);
	static v8::Handle<v8::Value> collapseActionView(const v8::Arguments&);
	...
	static v8::Handle<v8::Value> setActionView(const v8::Arguments&);
	static v8::Handle<v8::Value> setEnabled(const v8::Arguments&);
	static v8::Handle<v8::Value> isActionViewExpanded(const v8::Arguments&);
	static v8::Handle<v8::Value> getTitle(const v8::Arguments&);
	static v8::Handle<v8::Value> setIcon(const v8::Arguments&);

	// Dynamic property accessors ----------------------------------------
	static void setter_showAsAction(v8::Local<v8::String> property, v8::Local<v8::Value> value, const v8::AccessorInfo& info);
	...
	static v8::Handle<v8::Value> getter_visible(v8::Local<v8::String> property, const v8::AccessorInfo& info);
	static void setter_visible(v8::Local<v8::String> property, v8::Local<v8::Value> value, const v8::AccessorInfo& info);
	static v8::Handle<v8::Value> getter_checkable(v8::Local<v8::String> property, const v8::AccessorInfo& info);
	...
	static v8::Handle<v8::Value> getter_actionViewExpanded(v8::Local<v8::String> property, const v8::AccessorInfo& info);
	static void setter_actionView(v8::Local<v8::String> property, v8::Local<v8::Value> value, const v8::AccessorInfo& info);
	...
	static v8::Handle<v8::Value> getter_checked(v8::Local<v8::String> property, const v8::AccessorInfo& info);
